...
export enum ActionType{
    GOT_ALL_COUPONS="OT_ALL_COUPONS",
...
export function gotCompaniesAction(companies: CompanyModel[]): CompanyAction {
    return {
...
export function gotOneCompanyAction(company:CompanyModel): CompanyAction {
    return {
